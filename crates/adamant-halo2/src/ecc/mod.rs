...
//!
//! Forked from upstream `halo2_gadgets 0.3.1`'s `src/ecc.rs` +
//! `src/ecc/` tree at Phase 6.8b.3 per CLAUDE.md §14.4
//! Decision 1 (Path C2). See
//! `crates/adamant-halo2/PROVENANCE.md` sub-arc 6.8b.3 for the
//! per-file behavioural-change record.
//!
//! Used by Phase 6.8b.4's §7.3.2 validity-circuit gadgets to
//! verify §7.2.2 stealth-address arithmetic
//! (`P = pk_s + s · G`) inside the proof.
...
pub(crate) mod tests {
    ...
    fn print_ecc_chip() {
        ...
        crate::proofs::dev::CircuitLayout::default()
