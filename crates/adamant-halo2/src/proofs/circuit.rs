...
use crate::proofs::plonk::{
    Advice, Any, Assigned, Column, Error, Fixed, Instance, Selector, TableColumn,
};
...
pub trait Chip<F: Field>: Sized {
    ...
    ///
    /// [`Circuit::configure`]: crate::proofs::plonk::Circuit::configure
    ...
    ///
    /// [`Circuit::synthesize`]: crate::proofs::plonk::Circuit::synthesize
