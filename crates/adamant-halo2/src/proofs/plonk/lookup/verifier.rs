...
impl<F: Field> Argument<F> {
    pub(in crate::proofs::plonk) fn read_permuted_commitments<
        C: CurveAffine,
...
impl<C: CurveAffine> PermutationCommitments<C> {
    pub(in crate::proofs::plonk) fn read_product_commitment<
        E: EncodedChallenge<C>,
        T: TranscriptRead<C, E>,
    >(
        self,
...
impl<C: CurveAffine> Evaluated<C> {
    ...
    pub(in crate::proofs::plonk) fn expressions<'a>(
        &'a self,
        l_0: C::Scalar,
        l_last: C::Scalar,
        l_blind: C::Scalar,
    ...
    pub(in crate::proofs::plonk) fn queries<'r, 'params: 'r>(
        &'r self,
        vk: &'r VerifyingKey<C>,
        x: ChallengeX<C>,
