...
#[derive(Debug)]
pub(in crate::proofs::plonk) struct Permuted<C: CurveAffine, Ev> {
...
#[derive(Debug)]
pub(in crate::proofs::plonk) struct Committed<C: CurveAffine, Ev> {
...
pub(in crate::proofs::plonk) struct Constructed<C: CurveAffine> {
    permuted_input_poly: Polynomial<C::Scalar, Coeff>,
    permuted_input_blind: Blind<C::Scalar>,
    permuted_table_poly: Polynomial<C::Scalar, Coeff>,
    permuted_table_blind: Blind<C::Scalar>,
...
pub(in crate::proofs::plonk) struct Evaluated<C: CurveAffine> {
...
impl<F: WithSmallOrderMulGroup<3>> Argument<F> {
    ...
    pub(in crate::proofs::plonk) fn commit_permuted<
        'a,
        C,
...
impl<C: CurveAffine, Ev: Copy + Send + Sync> Permuted<C, Ev> {
    ...
    #[allow(clippy::too_many_arguments)]
    pub(in crate::proofs::plonk) fn commit_product<
        E: EncodedChallenge<C>,
        R: RngCore,
        T: TranscriptWrite<C, E>,
    >(
...
impl<'a, C: CurveAffine, Ev: Copy + Send + Sync + 'a> Committed<C, Ev> {
    ...
    pub(in crate::proofs::plonk) fn construct(
        self,
        beta: ChallengeBeta<C>,
        gamma: ChallengeGamma<C>,
...
impl<C: CurveAffine> Constructed<C> {
    pub(in crate::proofs::plonk) fn evaluate<E: EncodedChallenge<C>, T: TranscriptWrite<C, E>>(
        self,
        pk: &ProvingKey<C>,
        x: ChallengeX<C>,
        transcript: &mut T,
...
impl<C: CurveAffine> Evaluated<C> {
    pub(in crate::proofs::plonk) fn open<'a>(
        &'a self,
        pk: &'a ProvingKey<C>,
        x: ChallengeX<C>,
