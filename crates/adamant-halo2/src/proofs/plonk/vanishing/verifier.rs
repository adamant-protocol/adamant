...
impl<C: CurveAffine> Argument<C> {
    pub(in crate::proofs::plonk) fn read_commitments_before_y<
...
impl<C: CurveAffine> Committed<C> {
    pub(in crate::proofs::plonk) fn read_commitments_after_y<
        E: EncodedChallenge<C>,
        T: TranscriptRead<C, E>,
    >(
        self,
...
impl<C: CurveAffine> Constructed<C> {
    pub(in crate::proofs::plonk) fn evaluate_after_x<
        E: EncodedChallenge<C>,
        T: TranscriptRead<C, E>,
    >(
        self,
...
impl<C: CurveAffine> PartiallyEvaluated<C> {
    pub(in crate::proofs::plonk) fn verify(
        self,
        params: &Params<C>,
...
impl<'params, C: CurveAffine> Evaluated<'params, C> {
    pub(in crate::proofs::plonk) fn queries<'r>(
        &'r self,
        x: ChallengeX<C>,
