...
use super::*;
use crate::proofs::{arithmetic::CurveAffine, transcript::ChallengeScalar};
...
fn test_roundtrip() {
    ...
    use crate::proofs::arithmetic::eval_polynomial;
    use crate::proofs::pasta::{EqAffine, Fp};
    use crate::proofs::transcript::Challenge255;
    ...
    let mut transcript =
        crate::proofs::transcript::Blake2bWrite::<_, _, Challenge255<_>>::init(vec![]);
    create_proof(
        &params,
        rng,
        &mut transcript,
...

    {
        let mut proof = &proof[..];
        let mut transcript =
            crate::proofs::transcript::Blake2bRead::<_, _, Challenge255<_>>::init(&mut proof);
