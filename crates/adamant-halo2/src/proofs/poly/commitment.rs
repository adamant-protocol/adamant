...
use crate::proofs::arithmetic::{best_fft, best_multiexp, parallelize, CurveAffine, CurveExt};
use crate::proofs::helpers::CurveRead;
...
fn test_commit_lagrange_epaffine() {
    ...
    use crate::proofs::pasta::{EpAffine, Fq};
