...
provides the borrow-graph data structure used by the verifier's
reference-safety pass. At this scaffold commit the workspace
plumbing is in place; the actual upstream source-file copy lands
