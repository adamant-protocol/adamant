...
provides the metering trait surface (`Meter`, `Scope`, etc.) used
by the verifier to enforce resource limits during verification.
At this scaffold commit the workspace plumbing is in place; the
actual upstream source-file copy lands in the follow-up vendor
